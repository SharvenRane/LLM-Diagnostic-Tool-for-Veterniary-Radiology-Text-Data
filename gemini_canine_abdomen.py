...
file_path = 'canine_abdomen_scoring.xlsx'
...
conditions_1 = ["gastritis", "ascites", "colitis", "liver_mass", "pancreatitis", "microhepatia",
                "small_intestinal_obstruction", "splenic_mass", "splenomegaly", "hepatomegaly"]
...
conditions = ["gastritis", "ascites", "colitis", "liver_mass", "pancreatitis", "microhepatia", 
              "small_intestinal_obstruction", "splenic_mass", "splenomegaly", "hepatomegaly"]
...
output_file_path = 'final_conditions_cleaned_canine_abdomen_gemini.xlsx'
